...
namespace ELMS.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SystemCodeId,Code,Description,OrderNo,CreatedById,CreatedOn,ModifiedId,ModifiedOn")] SystemCodeDetail systemCodeDetail)
        {
